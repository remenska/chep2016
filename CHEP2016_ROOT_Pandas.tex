...
We use it to ship the full build environment for ROOT\footnote{Running a Docker image requires a sudo access, which is why we did not use it to provide ROOT binaries directly}.
